          ...
          <div className='w-auto h-11 border border-[#E0E3E8] rounded-[5px] flex items-center gap-2.5 px-1.5'>
            {typeOfPlayer?.map((pt, i) => {
              return (
                <div
                  key={i}
                  className={`w-28 capitalize h-8 text-center flex items-center justify-center gap-1.5 rounded-full cursor-pointer ${
                    playerType === pt.label ? 'bg-[#f0f1f2] text-[#3B82F6]' : ''
                  }`}
                  onClick={() => {
